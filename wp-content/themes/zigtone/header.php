                    ...
                    <nav class="navbar py-0">
                        ...
                        <div class="search-box hide-on-search">
                            <form class="search ps-lg-3" action="https://mobcup.com.co/" required="true" role="search">
                                <input id="search" class="form-control rounded-pill" autocomplete="off" name="s" required="true" type="search" value="" placeholder="Type and Click on the search ..." aria-label="Search">
