...
<div class="ringtone grid-item" data-id="<?php the_ID(); ?>">
    ...
    <div class="bottom-wrap">
        <div class="action">
            <div class="btn btn-icon btn-sm btn-default rounded-pill me-2 share" data-url="<?php the_permalink(); ?>" data-title="<?php the_title_attribute(); ?>" data-bs-toggle="modal" data-bs-target="#share_tkkb">
        ...
        <a class="btn btn-red rounded-pill download" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
