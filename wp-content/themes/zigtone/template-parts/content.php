    ...
    <div class="details">
        <div class="controls">
            <div class="mediPlayer" data-fid="<?php echo esc_attr($ringtone_url); ?>">
                <svg class="play-music" fill="#000000" height="35px" width="35px" version="1.1"
                ...
                <svg class="icon spin spin-loading" fill="#000000" width="35px" height="35px"
    ...
    <div class="bottom-wrap">
        <div class="action">
            <div class="btn btn-icon btn-sm btn-default rounded-pill me-2 share"
                ...
                <svg class="share share-icon" fill="#000000" height="16px" width="16px"
