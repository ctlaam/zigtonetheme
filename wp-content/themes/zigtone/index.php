        ...
        <div class="container main">
            <div class="content">
                <section class="section ringtone">
                    ...
                    <div class="ad">
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3445999244031312"
                             data-ad-slot="5165091296" data-ad-format="auto" data-full-width-responsive="true">
                            <iframe id="aswift_0"
                            ...
                            <div class="sb-body">
                                <ul class="ringtones list-group">
                                    <li class="ringtone list-group-item" data-id="14067">
                                        ...
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/tu-maro-dariyo-ringtone-download-pagalworld-4nz0gs8"
                                               ...
                                               title="Tu Maro Dariyo Ringtone Download Pagalworld">Tu Maro Dariyo Song
                                                Ringtone Download</a>
                                    ...
                                    <li class="ringtone list-group-item" data-id="24066">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="mqnpsjh7r652j5kgxcdvya7te3n1uoabi">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/tu-mala-anguracha-ringtone-download-r652j5k"
                                               class="list-group-title text-truncate"
                                               title="Tu Mala Anguracha – Ek Phool | TDM Ringtone">Tu Mala Anguracha
                                                Song Ringtone Download</a>
                                            <span class="list-group-subtitle">00:28 sec • 100 views</span>
                                        </div>
                                        <span class="btn btn-icon btn-sm btn-default rounded-pill me-2 d-btn"><svg
                                                    class="icon download-icon"><use
                                                        xlink:href="#download-icon"></use></svg></span>
                                        <span class="list-group-number">#2</span>
                                    </li>
                                    <li class="ringtone list-group-item" data-id="34065">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="uwk93c4qpcfmaj4wazr1v1qxyx5smlisl">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/nazara-khasa-aala-chahar-ringtone-download-pcfmaj4"
                                               class="list-group-title text-truncate"
                                               title="Nazara – Khasa Aala Chahar | Haryanvi Ringtone">Nazara Song
                                                Ringtone Download</a>
                                    ...
                                    <li class="ringtone list-group-item" data-id="44064">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="jc16m5o924fxijbmieobjm1cyw6zj20ty">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/pagal-babbu-maan-ringtone-download-24fxijb"
                                               class="list-group-title text-truncate"
                                               title="Pagal – Babbu Maan | Guru Randhawa Ringtone">Pagal Song Ringtone
                                                Download</a>
                                    ...
                                    <li class="ringtone list-group-item" data-id="54063">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="01gw8yi64hxqwuoays5j3ucix0p8qk9yg">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/laake-logdi-de-gut-naal-phul-ni-ringtone-download-4hxqwuo"
                                               class="list-group-title text-truncate"
                                               title="Laake Logdi De Gut Naal Phul Ni – Jind Kad Ke | Instagram Reels Ringtone">Laake
                            ...
                            <div class="sb-body">
                                <ul class="ringtones list-group">
                                    <li class="ringtone list-group-item" data-id="139">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="mayfhj9wai4hep4qglxv50goha0jt2qcy">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/leo-ordinary-person-ringtone-ai4hep4"
                                               class="list-group-title text-truncate"
                                               title="LEO Ordinary Person Ringtone Download">LEO Ordinary Person Song
                                                Ringtone Download</a>
                                    ...
                                    <li class="ringtone list-group-item" data-id="245">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="b05w9scn8yj2haby1d0shszg60tmp70u1">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/ruaan-hindi-song-ringtone-8yj2hab"
                                               class="list-group-title text-truncate"
                                               title="Ruaan – Tiger 3 | Arijit Singh | Hindi Song Ringtone Download">Ruaan
                                                Song Ringtone Download</a>
                                    ...
                                    <li class="ringtone list-group-item" data-id="347">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="gdt5ywxrhn6mx20qvx8yuhxmewvp97xvd">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/tujhe-yaad-na-meri-aayi-2-ringtone-b-praak-hn6mx20"
                                               class="list-group-title text-truncate"
                                               title="Tujhe Yaad Na Meri Aayi 2 Ringtone Download – B Praak">Tujhe Yaad
                                    ...
                                    <li class="ringtone list-group-item" data-id="451">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="z67cmrsi6194lf7l38vqo0xaz0gsjajc4">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/sunte-hain-jab-pyar-ho-to-instrumental-ringtone-6194lf7"
                                               class="list-group-title text-truncate"
                                               title="Sunte Hain Jab Pyar Ho To Instrumental Ringtone Download">Sunte
                                    ...
                                    <li class="ringtone list-group-item" data-id="552">
                                        <div class="list-group-player mediPlayer"
                                             data-fid="tz1yjkrioveh7p25staz6xsyovpjhsfqw">
                                            <svg class="icon play">
                                                <use xlink:href="#play-icon"></use>
                                            </svg>
                                        </div>
                                        <div class="list-group-content">
                                            <a href="https://mobcup.com.co/so-beautiful-so-elegant-just-looking-like-a-wow-ringtone-oveh7p2"
                                               class="list-group-title text-truncate"
                                               title="So Beautiful So Elegant JUst Looking Like A Wow Ringtone Download">So
